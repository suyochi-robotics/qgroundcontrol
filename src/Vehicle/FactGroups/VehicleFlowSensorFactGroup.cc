...
{
    Q_UNUSED(vehicle);
    qCDebug(FlowSensorLog) << "RAW msgid received:" << message.msgid << "expected:" << MAVLINK_MSG_ID_FLOW_SENSOR;
    ...
    switch (message.msgid) {
        case MAVLINK_MSG_ID_FLOW_SENSOR:
            qCInfo(FlowSensorLog) << "FlowSensor Message received in FlowsensorFactGroup:" << message.msgid;
